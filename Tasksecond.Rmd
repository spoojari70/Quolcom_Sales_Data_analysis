...
scalingFactorForControlCustomers <- preTrialMeasures[STORE_NBR == trial_store & 
...
measureOverTimeCusts <- measureOverTime # Use the full measureOverTime table
...
percentageDiff <- merge(scaledControlCustomers[, c("YEARMONTH", "controlCustomers")], 
                        ...
                        by = "YEARMONTH"
                        )[, percentageDiff := abs(controlCustomers - nCustomers) / controlCustomers]#### Scale pre-trial control customers to match pre-trial trial store customers
...
degreesOfFreedom <- 8 # Re-define degrees of freedom (8 months pre-trial - 1)
```
